...
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_int_to_string(long long int number)
{
    ...
    *p-- = '\0';
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(return_value == NULL))
    {
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_int_to_string_with_buffer(long long int number, char *buffer)
{
    char *p;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_utoa(size_t unsigned_value, char *output)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(output);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_uint_to_string(size_t number)
{
    char buffer[MY_COMPANY_FOUNDATIONAL_LIB_SIZE_STRING_OF_NUMBER_SIZE_PLUS_ZERO_TERMINATOR];

    MY_COMPANY_utoa(number, buffer);

    char *return_value = MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_STRDUP(buffer);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(return_value == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_uint_array(const unsigned long long *array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');

    for (size_t i = 0; i < size; ++i)
    {
        const unsigned int value = array[i];
        char buf[MY_COMPANY_FOUNDATIONAL_LIB_SIZE_STRING_OF_NUMBER_SIZE_PLUS_ZERO_TERMINATOR];

        MY_COMPANY_utoa(value, buf);
        MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTS(buf, stdout);
        if (i < size - 1)
        {
            MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR(',');
            MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR(' ');
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_uint_ptr_array(const unsigned int **array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_int_array(const int *array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
    ...
    for (size_t i = 0; i < size; ++i)
    {
        ...
        MY_COMPANY_int_to_string_with_buffer(value, buf);
        MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTS(buf, stdout);
        if (i < size - 1)
        {
            MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR(',');
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_int_ptr_array(const int **array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_string_array(char **array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
    ...
    for (size_t i = 0; i < size; ++i)
    {
        MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTS(array[i], stdout);
        if (i < size - 1)
        {
            MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR(',');
            MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR(' ');
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_string_array_array(char ***array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_ushort_array(const unsigned short *array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_ushort_ptr_array(const unsigned short **array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_short_array(const short *array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_short_ptr_array(const short **array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_ulong_array(const unsigned long *array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_ulong_ptr_array(const unsigned long **array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_long_array(const long *array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_long_ptr_array(const long **array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_ulong_long_array(const unsigned long long *array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_ulong_long_ptr_array(const unsigned long long **array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_long_long_array(const long long *array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_long_long_ptr_array(const long long **array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_float_array(const float *array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
    for (size_t i = 0; i < size; ++i)
    {
        MY_COMPANY_MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PRINTF("%f", array[i]);
        if (i < size - 1)
        {
            MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTS(", ", stdout);
        }
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_float_ptr_array(const float **array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_double_array(const double *array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
    for (size_t i = 0; i < size; ++i)
    {
        MY_COMPANY_MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PRINTF("%lf", array[i]);
        if (i < size - 1)
        {
            MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTS(", ", stdout);
        }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_double_ptr_array(const double **array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_size_t_array(const size_t *array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_size_t_ptr_array(const size_t **array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PUTCHAR('[');
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_uint_array_to_stream(const unsigned int *array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
    {
        MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPRINTF(stream, "%u", array[i]);
        if (i < size - 1)
        {
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_uint_ptr_array_to_stream(const unsigned int **array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_int_array_to_stream(const int *array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_int_ptr_array_to_stream(const int **array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_uchar_array_to_stream(const unsigned char *array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
    {
        MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPRINTF(stream, "%c", array[i]);
        if (i < size - 1)
        {
            MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTS(", ", stream);
        }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_char_array_to_stream(const char *array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_string_array_to_stream(char **array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
    {
        MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTS(array[i], stream);
        if (i < size - 1)
        {
            MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTS(", ", stream);
        }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_string_array_array_to_stream(char ***array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_ushort_array_to_stream(const unsigned short *array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
    {
        MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPRINTF(stream, "%hu", array[i]);
        if (i < size - 1)
        {
            MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTS(", ", stream);
        }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_ushort_ptr_array_to_stream(const unsigned short **array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_short_array_to_stream(const short *array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_short_ptr_array_to_stream(const short **array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_ulong_array_to_stream(const unsigned long *array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_ulong_ptr_array_to_stream(const unsigned long **array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_long_array_to_stream(const long *array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_long_ptr_array_to_stream(const long **array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_ulong_long_array_to_stream(const unsigned long long *array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
    {
        ...
        MY_COMPANY_utoa(value, buffer);
        MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTS(buffer, stream);
        if (i < size - 1)
        {
            MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTS(", ", stream);
        }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_ulong_long_ptr_array_to_stream(const unsigned long long **array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_long_long_array_to_stream(const long long *array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
    {
        ...
        MY_COMPANY_int_to_string_with_buffer(value, buffer);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_long_long_ptr_array_to_stream(const long long **array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_float_array_to_stream(const float *array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_float_ptr_array_to_stream(const float **array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_double_array_to_stream(const double *array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_double_ptr_array_to_stream(const double **array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_size_t_array_to_stream(const size_t *array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_size_t_ptr_array_to_stream(const size_t **array, size_t size, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPUTC('[', stream);
    for (size_t i = 0; i < size; ++i)
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void *MY_COMPANY_arraydup(const void *array, size_t num_mem, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    const size_t tot_size = FOUNDATIONAL_LIB_safe_mul(num_mem, size);

    // Check num_mem so safe_mul doesn't get confused.
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(num_mem && tot_size == 0))
    {
        /* Handle memory allocation failure */
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }
    char *duplicate = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(tot_size);

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(duplicate == NULL))
    {
        /* Handle memory allocation failure */
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
static inline int equal_strings(const char *first, const char *second) { return MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRCMP(first, second) == 0; }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_string_to_json(const char *input_string)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(input_string);
    ...
    while (input_string[input_length])
    {
        if (input_string[input_length] == '"' || input_string[input_length] == '\\')
        {
            ...
            MY_COMPANY_FOUNDATIONAL_LIB_safe_increment(escaped_length, overflow); // Need to escape with a backslash
        }

        // If the string uses most of memory and is filled with \ or ", there could be an overflow.
        // Check for this.
        MY_COMPANY_FOUNDATIONAL_LIB_safe_increment(escaped_length, overflow);
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(alloc_size == 0))
        goto overflow;

    char *json_result;

    json_result = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(alloc_size);

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(json_result == NULL))
    {
        goto memory_error;
    }
    ...
    for (size_t j = 1, i = 0; i < input_length; ++i, ++j)
    {
        ...
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(input_string[i] == '"' || input_string[i] == '\\'))
        {
            json_result[j] = '\\';
            ++j;
        }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_strip(const char *str)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str);
    size_t end = MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRLEN(str);
    ...
    while (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ISSPACE(str[start]))
    {
        ++start;
    }

    /* Trim trailing whitespace */
    while (end > start && MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ISSPACE(str[end - 1]))
    {
        --end;
    }
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(alloc_len == SIZE_MAX))
        goto overflow;
    ++alloc_len;

    char *result;
    result = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(alloc_len); /* Safe. */

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(result == NULL))
        goto memory_error;

    // Copy everything before the null byte.
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MEMCPY(result, str + start, memcpy_len); /* Safe. */
    result[memcpy_len] = '\0';
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char **MY_COMPANY_split(const char *str, size_t *output_size, const char *delim, size_t max_times, int keep_delim_in_result)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(output_size);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(delim);
    ...
    *output_size = 1;
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_len == 0 && *output_size))
        goto overflow;

    /* Allocate memory for the array of strings */
    char **result;

    result = (char **)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(new_len);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(result == NULL))
        goto memory_error;
    ...
    for (size_t i = 0; i < *output_size; ++i)
    {
        ...
        if (ptr != NULL)
        {
            ...
            result[i] = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(alloc_len); /* Safe. */
            if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(result[i] == NULL))
            {
                MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(result);
                goto memory_error;
            }

            MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MEMCPY(result[i], token_start, token_length); /* Safe. */
        ...
        else /* ptr is NULL */
        {
            ...
            const size_t token_length = MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRLEN(token_start);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_join(const char **array, size_t count, const char *delimiter)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(delimiter);

    const size_t new_size = FOUNDATIONAL_LIB_safe_mul(sizeof(size_t), count);
    // Check count so safe_mul doesn't get confused.
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_size == 0 && count))
        goto overflow;
    size_t *lens;

    lens = (size_t *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(new_size);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(lens == NULL))
        goto memory_error;
    size_t delimeter_length;

    delimeter_length = MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRLEN(delimiter);
    ...
    result = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(total_length);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(result == NULL))
    {
        goto memory_error;
    }
    ...
    MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(lens);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_append_string_to_string(char **string, size_t *string_length, size_t *string_alloc_size, const char *string_to_get_appended, size_t string_to_get_appended_length)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(string);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(string_length);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(string_alloc_size);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(string_to_get_appended);
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_size == 0))
        goto overflow;
    ...
    if (new_size > *string_alloc_size)
    {
        ...
        char *new_string = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_REALLOC(*string, new_size);

        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_string == NULL))
            goto memory_error;
        *string = new_string;
    ...
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MEMCPY(*string + *string_length, string_to_get_appended, string_to_get_appended_length); /* Safe. */
...
#define MY_COMPANY_FOUNDATIONAL_LIB_INITIAL_DATA_ARRAY_ALLOC_SIZE MY_COMPANY_FOUNDATIONAL_LIB_INITIAL_STRING_ARRAY_ALLOC_SIZE
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_append_data_to_array(void **array, size_t *array_size, size_t *array_current_alloc_size, void *data, size_t data_size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array_size);

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array_current_alloc_size);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(data);

    // The _no_alloc functions omit this for optimization.
    if (*array_current_alloc_size == 0)
    {
        *array = (void *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(MY_COMPANY_FOUNDATIONAL_LIB_INITIAL_DATA_ARRAY_ALLOC_SIZE);
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(*array == NULL))
        {
            *array_size = 0;
            *array_current_alloc_size = 0;
            goto memory_error;
        }
        *array_size = MY_COMPANY_FOUNDATIONAL_LIB_INITIAL_STRING_ARRAY_ALLOC_COUNT;
        *array_current_alloc_size = MY_COMPANY_FOUNDATIONAL_LIB_INITIAL_STRING_ARRAY_ALLOC_SIZE;
    }
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(mul == 0 && new_size && data_size))
        goto overflow;
    ...
    if (mul > *array_current_alloc_size)
    {
        ...
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_size_total == 0))
            goto overflow;

        void **new_array = (void **)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_REALLOC(*array, new_size_total);
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_array == NULL))
            goto memory_error;
    ...
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MEMCPY((char *)*array + (*array_size) * data_size, data, data_size); /* Safe. */
    ++*array_size;
    return 0;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_append_data_to_array_no_initial_alloc(void **array, size_t *array_size, size_t *array_current_alloc_size, void *data, size_t data_size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array_size);
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(nsize == 0 && new_size && data_size))
        goto overflow;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_append_string_to_array(char ***array, size_t *array_size, size_t *array_current_alloc_size, const char *string)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array_size);
    ...
    if (*array_current_alloc_size == 0)
    {
        *array = (char **)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(MY_COMPANY_FOUNDATIONAL_LIB_INITIAL_STRING_ARRAY_ALLOC_SIZE);
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(*array == NULL))
        {
            *array_size = 0;
            *array_current_alloc_size = 0;
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_size_total == 0 && *array_size))
        goto overflow;
    ...
    if (new_size_total > *array_current_alloc_size)
    {
        ...
        char **new_array = (char **)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_REALLOC(*array, new_size_total);
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_array == NULL))
            goto memory_error;
        *array = new_array;
        *array_current_alloc_size = new_size_total;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_append_string_to_array_no_initial_alloc(char ***array, size_t *array_size, size_t *array_current_alloc_size, const char *string)
{
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_prepend_string_to_array(char ***array, size_t *array_size, size_t *array_current_alloc_size, char *string)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array_size);
    ...
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MEMMOVE(*array + 1 /* dest location */, *array /* src location */, ((*array_size++) * sizeof(char *)) /* size */);

    /* MY_COMPANY_Set the string in the 0th position. */
    **array = string;
    return 0;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_prepend_string_to_array_no_initial_alloc(char ***array, size_t *array_size, size_t *array_current_alloc_size, char *string)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array_size);
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(copy_size == 0 && *array_size))
        goto overflow;
    ...
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MEMMOVE(*array + 1 /* dest location */, *array /* src location */, (copy_size) /* size */);
    ++array_size;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC size_t MY_COMPANY_array_total_string_length(char **array, size_t count)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    size_t length = 0;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_shellescape(const char *input)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(input);
    const size_t input_len = MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRLEN(input);

    const size_t size_with_null_t = input_len + 1;
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(size_with_null_t == 0))
        goto overflow;
    size_t escaped_len;

    escaped_len = FOUNDATIONAL_LIB_safe_mul(2, size_with_null_t);

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(escaped_len == 0))
        goto overflow;

    char *escaped;

    escaped = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(escaped_len);

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(escaped == NULL))
        goto memory_error;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_reverse_string(const char *str)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str);
    char *new_str = MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_STRDUP(str);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_str == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
static inline int starts_with(const char *str, const char *prefix) { return strncmp(str, prefix, MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRLEN(prefix)) == 0; }
...
{
    const size_t str_len = MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRLEN(str);
    const size_t suffix_len = MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRLEN(suffix);
...
#define MY_COMPANY_memory_locate memmem

#else

/* @brief Cross platform memmem(). Slower though. We need to find a faster solution for Windows. Maybe using assembly. */
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void *MY_COMPANY_MY_COMPANY_memory_locate(const void *haystack, size_t haystack_len, const void *needle, size_t needle_len)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(haystack);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(needle_len);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(needle_len == 0))
    {
        return (void *)haystack;
    }

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(haystack_len < needle_len))
    {
        return NULL;
    }
    ...
    {
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MEMCMP(h + i, n, needle_len) == 0)
        {
            return (void *)(h + i);
        }
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC size_t MY_COMPANY_count_occurrences_of_substr(const char *str, const char *substring)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(substring);
    const size_t substring_length = MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRLEN(substring);
    const char *pos = str;
    size_t count = 0;

    while ((pos = MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRSTR(pos, substring)) != NULL)
    {
        ++count;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_string_has_substr(const char *string, size_t string_length, const char *substring, size_t substring_length)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(string);

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(substring);

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(string_length == 0))
    {
        return 0;
    }

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(substring_length == 0))
    {
        return 0;
    }

    const char *beginning_of_substr_or_null = MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRSTR(string, substring);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_memory_has_subchunk(void *memory, size_t memory_length, void *subchunk, size_t subchunk_length)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(memory);

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(subchunk);

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(memory_length == 0))
    {
        return 0;
    }

    // Alias to memmem() if we can.
    return (const char *)MY_COMPANY_MY_COMPANY_memory_locate(memory, memory_length, subchunk, subchunk_length) != NULL;
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC size_t MY_COMPANY_count_occurrences_of_substr_len(const char *string, size_t string_length, const char *substring, size_t substring_length)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(string);
    ...
    /* This might be significantly faster than MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRSTR() */
    for (;;)
    {
        const char *beginning_of_substr_or_null = (const char *)memmem(string + pos, string_length, substring, substring_length);

        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(beginning_of_substr_or_null == NULL))
            break;
...
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str);
    const char *result = MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRCHR(str, chr);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_is_string_numeric(const char *str)
{
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_is_string_alphanumeric(const char *str)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_longest_common_prefix(const char **strings, size_t count)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(strings);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(count == 0))
    {
        char *ret = MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_STRDUP(""); // Empty string for an empty array
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(ret == NULL))
        {
            MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
            return NULL;
        }
    ...
    size_t max_common_len = MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRLEN(strings[0]);

    /* Find the max common length among the strings */
    for (size_t i = 1; i < count; ++i)
    {
        size_t current_len = MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRLEN(strings[i]);
    ...
    for (size_t i = 0; i < max_common_len; ++i)
    {
        for (size_t j = 1; j < count; ++j)
        {
            if (strings[j][i] != strings[0][i])
            {
                ...
                // Don't MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC 0.
                if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(i == SIZE_MAX))
                {
                    MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
                    return NULL;
                }

                char *result = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(i + sizeof("")); /* Safe. */
                if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(result == NULL))
                {
                    MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
                    return NULL;
                }
                MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MEMCPY(result, strings[0], i);
                result[i] = '\0';
                return result;
            }
        }
    ...
    char *dup = MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_STRDUP(strings[0]);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_longest_common_suffix(const char **strings, size_t count)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(strings);

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(count == 0))
    {
        char *return_value = MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_STRDUP(""); // Empty string for an empty array
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(return_value == NULL))
        {
            MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
            return NULL;
    ...
    for (size_t i = 0; i < max_common_len; ++i)
    {
        for (size_t j = 1; j < count; ++j)
        {
            size_t current_len = MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRLEN(strings[j]);
            if (strings[j][current_len - i - 1] != strings[0][max_common_len - i - 1])
            {
                ...
                MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MEMCPY(result, strings[0] + max_common_len - i, i); /* Safe. */
                result[i] = '\0';
                return result;
            }
        }
    ...
    char *return_value = MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_STRDUP(strings[0] + max_common_len); /* Should be Safe. */
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(return_value == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC ssize_t MY_COMPANY_find_first_of(const char *str, const char *char_set)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(char_set);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC ssize_t MY_COMPANY_find_last_of(const char *str, const char *char_set)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(char_set);
    ...
    {
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRCHR(char_set, str[i]) != NULL)
        {
            return i;
        }
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_reverse_string_in_place(char *str)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_is_string_valid_integer(const char *str)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str);
    ...
    if (!MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ISDIGIT(*str))
    {
        return 0;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC size_t MY_COMPANY_common_prefix_length(const char *str1, const char *str2)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str1);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str2);

    const size_t len1 = MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRLEN(str1);
    const size_t len2 = MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRLEN(str2);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC size_t MY_COMPANY_common_suffix_length(const char *str1, const char *str2)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str1);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str2);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_string_to_title_case(const char *str)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str);

    const size_t len = MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRLEN(str);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(len == SIZE_MAX))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }

    char *title_case = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(len + sizeof("")); /* Safe. */

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(title_case == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }
    ...
    for (size_t i = 0; i < len; ++i)
    {
        ...
        {
            make_upper = 1; // MY_COMPANY_Set the flag to capitalize the next character
            title_case[i] = str[i];
        }
        else
        {
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_find_max_int_in_array(const int *array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(size == 0))
    {
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_find_min_int_in_array(const int *array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(size == 0))
    {
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_sum_of_int_array(const int *array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    int sum = 0;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_reverse_int_array_in_place(int *array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_ints_are_sorted_ascending(const int *array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    for (size_t i = 1; i < size; ++i)
    {
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_ints_are_sorted_descending(const int *array, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    for (size_t i = 1; i < size; ++i)
    {
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC size_t *MY_COMPANY_generate_range(size_t start, size_t end, size_t step, size_t *range_size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(range_size);
    // Check for invalid range
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(start > end || step == 0))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }
    ...
    size_t *range = (size_t *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(alloc_size);

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(range == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmpstringp(const void *p1, const void *p2)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(p1);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(p2);
    return MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRCMP(*(const char **)p1, *(const char **)p2);
}
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_strings(char **strings, size_t size)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(strings);
    qsort(strings, size, sizeof(char *), MY_COMPANY_FOUNDATIONAL_LIB_cmpstringp);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char **MY_COMPANY_sorted_strings(char **strings, size_t size)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(strings);

    char **dup_strings = (char **)MY_COMPANY_arraydup(strings, size, sizeof(char *));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_strings == NULL))
    {
        return NULL; /* No need to re die aggressively. */
    }
    qsort(dup_strings, size, sizeof(char *), MY_COMPANY_FOUNDATIONAL_LIB_cmpstringp);
    return dup_strings;
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_uints(const void *a, const void *b)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(a);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(b);
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_uints(unsigned int *uints, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(uints);

    qsort(uints, size, sizeof(unsigned int), MY_COMPANY_FOUNDATIONAL_LIB_cmp_uints);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC unsigned int *MY_COMPANY_sorted_uints(unsigned int *uints, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(uints);

    unsigned int *dup_uints = (unsigned int *)MY_COMPANY_arraydup(uints, size, sizeof(unsigned int));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_uints == NULL))
    {
        return NULL;
    }
    qsort(uints, size, sizeof(unsigned int), MY_COMPANY_FOUNDATIONAL_LIB_cmp_uints);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_uint_ptrs(const void *a, const void *b)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(a);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(b);
    return (*(unsigned int **)a - *(unsigned int **)b);
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_uint_ptrs(unsigned int **uint_ptrs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(uint_ptrs);

    qsort(uint_ptrs, size, sizeof(unsigned int *), MY_COMPANY_FOUNDATIONAL_LIB_cmp_uint_ptrs);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC unsigned int **MY_COMPANY_sorted_uint_ptrs(unsigned int **uint_ptrs, size_t size)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(uint_ptrs);

    unsigned int **dup_uint_ptrs = (unsigned int **)MY_COMPANY_arraydup(uint_ptrs, size, sizeof(unsigned int *));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_uint_ptrs == NULL))
    {
        return NULL;
    }
    qsort(uint_ptrs, size, sizeof(unsigned int *), MY_COMPANY_FOUNDATIONAL_LIB_cmp_uint_ptrs);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_ints(const void *a, const void *b)
{
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_ints(int *ints, size_t size)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(ints);
    qsort(ints, size, sizeof(int), MY_COMPANY_FOUNDATIONAL_LIB_cmp_ints);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int *MY_COMPANY_sorted_ints(int *ints, size_t size)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(ints);

    int *dup_ints = (int *)MY_COMPANY_arraydup(ints, size, sizeof(int));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_ints == NULL))
    {
        return NULL;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_int_ptrs(const void *a, const void *b)
{
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_int_ptrs(int **int_ptrs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(int_ptrs);
    qsort(int_ptrs, size, sizeof(int *), MY_COMPANY_FOUNDATIONAL_LIB_cmp_int_ptrs);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int **MY_COMPANY_sorted_int_ptrs(int **int_ptrs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(int_ptrs);
    int **dup_int_ptrs = (int **)MY_COMPANY_arraydup(int_ptrs, size, sizeof(int *));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_int_ptrs == NULL))
    {
        return NULL;
    }
    qsort(int_ptrs, size, sizeof(int *), MY_COMPANY_FOUNDATIONAL_LIB_cmp_int_ptrs);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_uchars(const void *a, const void *b)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(a);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(b);
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_uchars(unsigned char *uchars, size_t size)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(uchars);
    qsort(uchars, size, sizeof(unsigned char), MY_COMPANY_FOUNDATIONAL_LIB_cmp_uchars);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC unsigned char *MY_COMPANY_sorted_uchars(unsigned char *uchars, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(uchars);

    unsigned char *dup_uchars = (unsigned char *)MY_COMPANY_arraydup(uchars, size, sizeof(unsigned char));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_uchars == NULL))
    {
        return NULL;
    }
    qsort(uchars, size, sizeof(unsigned char), MY_COMPANY_FOUNDATIONAL_LIB_cmp_uchars);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_uchar_ptrs(const void *a, const void *b)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(a);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(b);
    return (*(unsigned char **)a - *(unsigned char **)b);
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_uchar_ptrs(unsigned char **uchar_ptrs, size_t size)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(uchar_ptrs);
    qsort(uchar_ptrs, size, sizeof(unsigned char *), MY_COMPANY_FOUNDATIONAL_LIB_cmp_uchar_ptrs);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC unsigned char **MY_COMPANY_sorted_uchar_ptrs(unsigned char **uchar_ptrs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(uchar_ptrs);
    unsigned char **dup_uchar_ptrs = (unsigned char **)MY_COMPANY_arraydup(uchar_ptrs, size, sizeof(unsigned char *));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_uchar_ptrs == NULL))
    {
        return NULL;
    }
    qsort(uchar_ptrs, size, sizeof(unsigned char *), MY_COMPANY_FOUNDATIONAL_LIB_cmp_uchar_ptrs);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_chars(const void *a, const void *b)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(a);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(b);
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_chars(char *chars, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(chars);
    qsort(chars, size, sizeof(char), MY_COMPANY_FOUNDATIONAL_LIB_cmp_chars);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_sorted_chars(char *chars, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(chars);
    char *dup_chars = (char *)MY_COMPANY_arraydup(chars, size, sizeof(char));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_chars == NULL))
    {
        return NULL;
    }
    qsort(chars, size, sizeof(char), MY_COMPANY_FOUNDATIONAL_LIB_cmp_chars);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_char_ptrs(const void *a, const void *b)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(a);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(b);
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_char_ptrs(char **char_ptrs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(char_ptrs);

    qsort(char_ptrs, size, sizeof(char *), MY_COMPANY_FOUNDATIONAL_LIB_cmp_char_ptrs);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char **MY_COMPANY_sorted_char_ptrs(char **char_ptrs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(char_ptrs);
    char **dup_char_ptrs = (char **)MY_COMPANY_arraydup(char_ptrs, size, sizeof(char *));

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_char_ptrs == NULL))
    {
        return NULL;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_ushorts(const void *a, const void *b)
{
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_ushorts(unsigned short *ushorts, size_t size)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(ushorts);

    qsort(ushorts, size, sizeof(unsigned short), MY_COMPANY_FOUNDATIONAL_LIB_cmp_ushorts);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC unsigned short *MY_COMPANY_sorted_ushorts(unsigned short *ushorts, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(ushorts);
    unsigned short *dup_ushorts = (unsigned short *)MY_COMPANY_arraydup(ushorts, size, sizeof(unsigned short));

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_ushorts == NULL))
    {
        return NULL;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_ushort_ptrs(const void *a, const void *b)
{
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_ushort_ptrs(unsigned short **ushort_ptrs, size_t size)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(ushort_ptrs);
    qsort(ushort_ptrs, size, sizeof(unsigned short *), MY_COMPANY_FOUNDATIONAL_LIB_cmp_ushort_ptrs);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC unsigned short **MY_COMPANY_sorted_ushort_ptrs(unsigned short **ushort_ptrs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(ushort_ptrs);

    unsigned short **dup_ushort_ptrs = (unsigned short **)MY_COMPANY_arraydup(ushort_ptrs, size, sizeof(unsigned short *));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_ushort_ptrs == NULL))
    {
        return NULL;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_shorts(const void *a, const void *b)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(a);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(b);
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_shorts(short *shorts, size_t size)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(shorts);
    qsort(shorts, size, sizeof(short), MY_COMPANY_FOUNDATIONAL_LIB_cmp_shorts);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC short *MY_COMPANY_sorted_shorts(short *shorts, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(shorts);

    short *dup_shorts = (short *)MY_COMPANY_arraydup(shorts, size, sizeof(short));

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_shorts == NULL))
    {
        return NULL;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_short_ptrs(const void *a, const void *b)
{
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_short_ptrs(short **short_ptrs, size_t size)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(short_ptrs);
    qsort(short_ptrs, size, sizeof(short *), MY_COMPANY_FOUNDATIONAL_LIB_cmp_short_ptrs);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC short **MY_COMPANY_sorted_short_ptrs(short **short_ptrs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(short_ptrs);

    short **dup_short_ptrs = (short **)MY_COMPANY_arraydup(short_ptrs, size, sizeof(short *));

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_short_ptrs == NULL))
    {
        return NULL;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_ulongs(const void *a, const void *b)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(a);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(b);
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_ulongs(unsigned long *ulongs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(ulongs);
    qsort(ulongs, size, sizeof(unsigned long), MY_COMPANY_FOUNDATIONAL_LIB_cmp_ulongs);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC unsigned long *MY_COMPANY_sorted_ulongs(unsigned long *ulongs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(ulongs);
    unsigned long *dup_ulongs = (unsigned long *)MY_COMPANY_arraydup(ulongs, size, sizeof(unsigned long));

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_ulongs == NULL))
    {
        return NULL;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_ulong_ptrs(const void *a, const void *b)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(a);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(b);
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_ulong_ptrs(unsigned long **ulong_ptrs, size_t size)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(ulong_ptrs);
    qsort(ulong_ptrs, size, sizeof(unsigned long *), MY_COMPANY_FOUNDATIONAL_LIB_cmp_ulong_ptrs);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC unsigned long **MY_COMPANY_sorted_ulong_ptrs(unsigned long **ulong_ptrs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(ulong_ptrs);

    unsigned long **dup_ulong_ptrs = (unsigned long **)MY_COMPANY_arraydup(ulong_ptrs, size, sizeof(unsigned long *));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_ulong_ptrs == NULL))
    {
        return NULL;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_longs(const void *a, const void *b)
{
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_longs(long *longs, size_t size)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(longs);

    qsort(longs, size, sizeof(long), MY_COMPANY_FOUNDATIONAL_LIB_cmp_longs);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC long *MY_COMPANY_sorted_longs(long *longs, size_t size)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(longs);

    long *dup_longs = (long *)MY_COMPANY_arraydup(longs, size, sizeof(long));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_longs == NULL))
    {
        return NULL;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_long_ptrs(const void *a, const void *b)
{
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_long_ptrs(long **long_ptrs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(long_ptrs);
    qsort(long_ptrs, size, sizeof(long *), MY_COMPANY_FOUNDATIONAL_LIB_cmp_long_ptrs);
}
/**
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC long **MY_COMPANY_sorted_long_ptrs(long **long_ptrs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(long_ptrs);
    long **dup_long_ptrs = (long **)MY_COMPANY_arraydup(long_ptrs, size, sizeof(long *));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_long_ptrs == NULL))
    {
        return NULL;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_ulong_longs(const void *a, const void *b)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(a);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(b);
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_ulong_longs(unsigned long long *ulong_longs, size_t size)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(ulong_longs);

    qsort(ulong_longs, size, sizeof(unsigned long long), MY_COMPANY_FOUNDATIONAL_LIB_cmp_ulong_longs);
}
/**
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC unsigned long long *MY_COMPANY_sorted_ulong_longs(unsigned long long *ulong_longs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(ulong_longs);
    unsigned long long *dup_ulong_longs = (unsigned long long *)MY_COMPANY_arraydup(ulong_longs, size, sizeof(unsigned long long));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_ulong_longs == NULL))
    {
        return NULL;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_ulong_long_ptrs(const void *a, const void *b)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(a);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(b);
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_ulong_long_ptrs(unsigned long long **ulong_long_ptrs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(ulong_long_ptrs);
    qsort(ulong_long_ptrs, size, sizeof(unsigned long long *), MY_COMPANY_FOUNDATIONAL_LIB_cmp_ulong_long_ptrs);
}
/**
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC unsigned long long **MY_COMPANY_sorted_ulong_long_ptrs(unsigned long long **ulong_long_ptrs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(ulong_long_ptrs);

    unsigned long long **dup_ulong_long_ptrs = (unsigned long long **)MY_COMPANY_arraydup(ulong_long_ptrs, size, sizeof(unsigned long long *));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_ulong_long_ptrs == NULL))
    {
        return NULL;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_long_longs(const void *a, const void *b)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(a);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(b);
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_long_longs(long long *long_longs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(long_longs);
    qsort(long_longs, size, sizeof(long long), MY_COMPANY_FOUNDATIONAL_LIB_cmp_long_longs);
}
/**
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC long long *MY_COMPANY_sorted_long_longs(long long *long_longs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(long_longs);
    long long *dup_long_longs = (long long *)MY_COMPANY_arraydup(long_longs, size, sizeof(long long));

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_long_longs == NULL))
    {
        return NULL;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_long_long_ptrs(const void *a, const void *b)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(a);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(b);
    return (*(long long **)a - *(long long **)b);
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_long_long_ptrs(long long **long_long_ptrs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(long_long_ptrs);
    qsort(long_long_ptrs, size, sizeof(long long *), MY_COMPANY_FOUNDATIONAL_LIB_cmp_long_long_ptrs);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC long long **MY_COMPANY_sorted_long_long_ptrs(long long **long_long_ptrs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(long_long_ptrs);

    long long **dup_long_long_ptrs = (long long **)MY_COMPANY_arraydup(long_long_ptrs, size, sizeof(long long *));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_long_long_ptrs == NULL))
    {
        return NULL;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_floats(const void *a, const void *b)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(a);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(b);
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_floats(float *floats, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(floats);
    qsort(floats, size, sizeof(float), MY_COMPANY_FOUNDATIONAL_LIB_cmp_floats);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC float *MY_COMPANY_sorted_floats(float *floats, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(floats);

    float *dup_floats = (float *)MY_COMPANY_arraydup(floats, size, sizeof(float));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_floats == NULL))
    {
        return NULL;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_float_ptrs(const void *a, const void *b)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(a);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(b);
    return (*(float **)a - *(float **)b);
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_float_ptrs(float **float_ptrs, size_t size)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(float_ptrs);
    qsort(float_ptrs, size, sizeof(float *), MY_COMPANY_FOUNDATIONAL_LIB_cmp_float_ptrs);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC float **MY_COMPANY_sorted_float_ptrs(float **float_ptrs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(float_ptrs);

    float **dup_float_ptrs = (float **)MY_COMPANY_arraydup(float_ptrs, size, sizeof(float *));

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_float_ptrs == NULL))
    {
        return NULL;
    }
    qsort(float_ptrs, size, sizeof(float *), MY_COMPANY_FOUNDATIONAL_LIB_cmp_float_ptrs);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_doubles(const void *a, const void *b)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(a);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(b);
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_doubles(double *doubles, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(doubles);
    qsort(doubles, size, sizeof(double), MY_COMPANY_FOUNDATIONAL_LIB_cmp_doubles);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC double *MY_COMPANY_sorted_doubles(double *doubles, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(doubles);
    double *dup_doubles = (double *)MY_COMPANY_arraydup(doubles, size, sizeof(double));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_doubles == NULL))
    {
        return NULL;
    }
    qsort(doubles, size, sizeof(double), MY_COMPANY_FOUNDATIONAL_LIB_cmp_doubles);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_double_ptrs(const void *a, const void *b)
{
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_double_ptrs(double **double_ptrs, size_t size)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(double_ptrs);
    qsort(double_ptrs, size, sizeof(double *), MY_COMPANY_FOUNDATIONAL_LIB_cmp_double_ptrs);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC double **MY_COMPANY_sorted_double_ptrs(double **double_ptrs, size_t size)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(double_ptrs);

    double **dup_double_ptrs = (double **)MY_COMPANY_arraydup(double_ptrs, size, sizeof(double *));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_double_ptrs == NULL))
    {
        return NULL;
    }
    qsort(double_ptrs, size, sizeof(double *), MY_COMPANY_FOUNDATIONAL_LIB_cmp_double_ptrs);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_size_ts(const void *a, const void *b)
{
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_size_ts(size_t *size_ts, size_t size)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(size_ts);
    qsort(size_ts, size, sizeof(size_t), MY_COMPANY_FOUNDATIONAL_LIB_cmp_size_ts);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC size_t *MY_COMPANY_sorted_size_ts(size_t *size_ts, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(size_ts);

    size_t *dup_size_ts = (size_t *)MY_COMPANY_arraydup(size_ts, size, sizeof(size_t));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_size_ts == NULL))
    {
        return NULL;
    }
    qsort(size_ts, size, sizeof(size_t), MY_COMPANY_FOUNDATIONAL_LIB_cmp_size_ts);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_cmp_size_t_ptrs(const void *a, const void *b)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(a);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(b);
    return (*(size_t **)a - *(size_t **)b);
 ...
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_sort_size_t_ptrs(size_t **size_t_ptrs, size_t size)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(size_t_ptrs);
    qsort(size_t_ptrs, size, sizeof(size_t *), MY_COMPANY_FOUNDATIONAL_LIB_cmp_size_t_ptrs);
}
/**
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC size_t **MY_COMPANY_sorted_size_t_ptrs(size_t **size_t_ptrs, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(size_t_ptrs);

    size_t **dup_size_t_ptrs = (size_t **)MY_COMPANY_arraydup(size_t_ptrs, size, sizeof(size_t *));

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dup_size_t_ptrs == NULL))
    {
        return NULL;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_string_to_int(const char *str)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str);
    return MY_COMPANY_FOUNDATIONAL_LIB_ATOI(str);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_read_file_into_string(const char *filename, size_t *size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(filename);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(size);

    *size = 0;

    FILE *file = fopen(filename, "rb");
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(file == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FSEEKO(file, 0, SEEK_END) != 0)
    {
        MY_COMPANY_FOUNDATIONAL_LIB_FCLOSE(file); // No need to error check here because already going wrong.
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }

    // Get file size with tell
    const off_t file_size = MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FTELLO(file); /* signed int type */
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(file_size == -1))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_FCLOSE(file); // No need to error check here because already going wrong.
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    ...
    *size = (size_t)file_size;
    ...
    // if it equals SIZE_MAX before adding 1 more to it to MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC()

    // Seek to the beginning again
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FSEEKO(file, 0, SEEK_SET) != 0)
    {
        MY_COMPANY_FOUNDATIONAL_LIB_FCLOSE(file); // No need to error check here because already going wrong.
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    ...
    char *content = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(file_size + 1); /* Safe. */
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(content == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_FCLOSE(file); // No need to error check here because already going wrong.
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    ...
    {
        const size_t read_size = MY_COMPANY_FOUNDATIONAL_LIB_FREAD(content + total_read, 1, file_size - total_read, file);

        if (read_size == 0) // Not likely or unlikely.
        {
            const int error_code = MY_COMPANY_FOUNDATIONAL_LIB_FERROR(file);
            if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(error_code))
            {
                MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(content);
                MY_COMPANY_FOUNDATIONAL_LIB_FCLOSE(file); // Don't need to error check here because things are going
                                               // wrong.
                MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
                return NULL;
            }
    ...
    // Close the file
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(fclose(file) != 0)) // Check for errors.
    {
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(content);
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_write_to_file_with_mode(const char *filename, const char *content, size_t content_length, const char *mode)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(filename);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(content);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(mode);
    ...
    while ((write_size = MY_COMPANY_FOUNDATIONAL_LIB_FWRITE(content + total_written, 1, content_length - total_written, file)) > 0)
    {
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_write_file(const char *filename, const char *content)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(filename);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(content);

    /* This function is inlined by default. */
    return MY_COMPANY_write_to_file_with_mode(filename, content, MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRLEN(content), "w");
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_append_string_to_file(const char *filename, const char *content)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(filename);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(content);

    /* This function is inlined by default. */
    return MY_COMPANY_write_to_file_with_mode(filename, content, MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRLEN(content), "a");
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_file_exists(const char *filename)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(filename);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_file_is_regular(const char *filename)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(filename);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_file_is_directory(const char *filename)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(filename);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_file_is_readable(const char *filename)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(filename);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_file_is_writable(const char *filename)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(filename);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_file_is_executable(const char *filename)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(filename);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_get_file_size(const char *filename, size_t *size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(filename);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(size);
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FSEEKO(file, 0, SEEK_END) != 0))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_FCLOSE(file); // No need to error check here because already going wrong.
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return -1;
    ...
    // Close the file
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(fclose(file) != 0)) // Error check
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return -1;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_remove_file(const char *filename)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(filename);

    /* Standard c function */
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(remove(filename) != 0))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return -1;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_copy_file(const char *source_filename, const char *destination_filename)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(source_filename);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(destination_filename);
    FILE *source_file = fopen(source_filename, "rb");

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(source_file == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return -1;
    }
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(destination_file == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_FCLOSE(source_file); // No need to error check here because already going
                                              // wrong.
    ...
    char buffer[MY_COMPANY_FOUNDATIONAL_LIB_COPY_SIZE_AMOUNT];
    ...
    for (;;)
    {
        ...
        do
        {
            read_size = MY_COMPANY_FOUNDATIONAL_LIB_FREAD(buffer, 1, sizeof(buffer), source_file);
        } while (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY((error_code = MY_COMPANY_FOUNDATIONAL_LIB_FERROR(source_file)) && errno == EINTR)); /* Check for EINTR */
        ...
        if (read_size == 0) // Not likely or unlikely.
        {
            if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(error_code))
            {
                ...
                MY_COMPANY_FOUNDATIONAL_LIB_FCLOSE(destination_file); // Don't need to error check here because
                                                           // things are going wrong.
                MY_COMPANY_FOUNDATIONAL_LIB_FCLOSE(source_file);      // Don't need to error check here because things
                                                           // are going wrong.
        ...
        do
        {
            new_write_size = MY_COMPANY_FOUNDATIONAL_LIB_FWRITE(buffer + write_size, 1, read_size - write_size, destination_file);
            write_size += new_write_size;
        } while (write_size != read_size || MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(errno == EINTR)); /* Check for EINTR */
    }

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(ferror(source_file) != 0 || MY_COMPANY_FOUNDATIONAL_LIB_FERROR(destination_file) != 0))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_FCLOSE(source_file);      // No need to error check here because already going
                                                   // wrong.
        MY_COMPANY_FOUNDATIONAL_LIB_FCLOSE(destination_file); // No need to error check here because already
                                                   // going wrong.
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(fclose(source_file) != 0 || MY_COMPANY_FOUNDATIONAL_LIB_FCLOSE(destination_file) != 0)) // Error check
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return -1;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char **MY_COMPANY_list_files_with_pattern(const char *directory, const char *pattern, size_t *len)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(directory);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(pattern);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(len);

    *len = 0;
    char search_path[MAX_PATH];
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_SNPRINTF(search_path, MAX_PATH, "%s\\%s", directory, pattern);

    WIN32_FIND_DATA find_file_data;
    HANDLE find_handle = FindFirstFile(search_path, &find_file_data);

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(find_handle == INVALID_HANDLE_VALUE))
    {

        /* One element of size zero. */
        char **new_array = (char **)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(sizeof(char *));
        *new_array = NULL;
        return new_array;
    }
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(file_count == 0))
    {
        mul = MY_COMPANY_FOUNDATIONAL_LIB_INITIAL_STRING_ARRAY_ALLOC_SIZE;
    }
    else if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(FOUNDATIONAL_LIB_safe_mul_ptr(file_count, sizeof(char *), &mul) == 0))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }
    ...
    /* Allocate memory for the array of strings */
    char **files_array = (char **)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(mul);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(files_array == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }
    ...
    int index = 0;
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(FindClose(find_handle) == 0))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }
    ...
    do
    {
        if (!(find_file_data.dwFileAttributes & FILE_ATTRIBUTE_DIRECTORY))
        {
            files_array[index] = MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_STRDUP(find_file_data.cFileName);
            if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(files_array[index] == NULL))
            {
                return NULL;
            }
            ++index;
...
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char **MY_COMPANY_list_files_with_pattern(const char *directory, const char *pattern, size_t *len)
{
    ...
    *len = 0;
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(dir == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }
    ...
    while ((entry = readdir(dir)) != NULL)
    {
        if (fnmatch(pattern, entry->d_name, FNM_PERIOD) == 0)
        {
            files_array[index] = MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_STRDUP(entry->d_name);
            if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(files_array[index] == NULL))
            {
                MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
                return NULL;
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(closedir(dir) == -1))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_concatenate_string_array(const char **strings, size_t num_strings)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(strings);

    /* Initialize total length and allocate initial memory for result */
    size_t alloc_size = MY_COMPANY_FOUNDATIONAL_LIB_INITIAL_STRING_ARRAY_ALLOC_SIZE;
    char *result = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(alloc_size);
    ...
    // Concatenate the strings char by char using MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MEMCPY and MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_REALLOC
    for (size_t i = 0; i < num_strings; ++i)
    {
        ...
        {
            if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_len == SIZE_MAX))
                goto overflow;
            ...
            if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_size > alloc_size))
            {
                char *new_result = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_REALLOC(result, new_size);

                // Check for realloc failure
                if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_result == NULL))
                {
                    MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(result);
                    goto memory_error;
                }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_concatenate_strings(const char *str1, const char *str2)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str1);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str2);
    ...
    return MY_COMPANY_concatenate_string_array(strs, 2);
}
 ...
 *
 *       It seems impementations of memmem() and MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRSTR() can vary speed-wise depending on machine. On one of my machines, memmem() was MUCH faster
 *       whereas on my other machine, MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRSTR() was faster (strangely). We should reimplement these functions in assembly, or use a library to have
 *       IDEAL version of these.
 */
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_replace_memory(void *source, size_t source_len, void *find, size_t find_len, void *replace, size_t replace_len, void **output, size_t *output_length_without_nullt, int *should_free_after_use, size_t matches_max /* 0 for unlimited replacement */, size_t *num_matches_found, int should_nullt)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(source);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(find);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(replace);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(output);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(output_length_without_nullt);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(should_free_after_use);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(num_matches_found);

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(find_len == 0))
        goto no_matches;
    ...
    for (;;)
    {
        if ((p = (const char *)MY_COMPANY_MY_COMPANY_memory_locate((const void *)p, (end_of_memory - p), find, find_len)) == NULL)
            break;
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(matches == 0))
    {
    no_matches:
    ...
    *num_matches_found = matches;
    ...
    result = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(final_len);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(result == NULL))
    {
        goto memory_error;
    }
    ...
    *output = result;
    ...
    for (matches = 0; !matches_max || (matches < matches_max); ++matches)
    {
        ...
        MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MEMCPY(rp, source, prefix_len);
        rp += prefix_len;
        MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MEMCPY(rp, replace, replace_len);
        rp += replace_len;
        p += find_len;
        source = (void *)p;
    }
    ...
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MEMCPY(rp, source, remaining_len);
 ...
 *
 * @note For efficiency, null terminated strings are not checked. As such, the blocks of memory that are being replaced CAN contain null bytes.
 *       Internally, memmem() / MY_COMPANY_MY_COMPANY_memory_locate() is used to locate memory. See benchark_lib.c to see just how much FASTER this function can make things.
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_replace_all_with_lens(const char *source, size_t source_len, const char *find, size_t find_len, const char *replace, size_t replace_len, char **output, size_t *new_len, int *should_free_after_use, size_t matches_max, size_t *num_matches)
{
    /* replace_memory checks args if enabled. */
    return MY_COMPANY_replace_memory((void *)source, source_len, (void *)find, find_len, (void *)replace, replace_len, (void **)output, new_len, should_free_after_use, matches_max, num_matches, 1);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_replace_all(const char *source, const char *find, const char *replace)
{
    /* replace_memory checks args if enabled. */
    ...
    if (MY_COMPANY_replace_memory((void *)source, strlen(source), (void *)find, strlen(find), (void *)replace, strlen(replace), (void **)&output, &new_len, &should_free_after_use, matches_max, &num_matches, 1) == -1)
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }
    ...
    if (!should_free_after_use)
    {
        ...
        char *new_output = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(new_len + 1); /* Safe. */
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_replace_first(const char *source, const char *find, const char *replace)
{
    /* replace_memory checks args if enabled. */
 ...
 * needed.
 */
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_replace_count(const char *source, const char *find, const char *replace, const size_t matches_max)
{
    /* replace_memory checks args if enabled. */
 ...
 */
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_replace_all_with_callback(const char *str, const char *old_substring, char *(*callback)(const char *, void *), void *data_for_callback)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(old_substring);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(callback);
    ...
    char *result = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(str_len);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(result == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    ...
    for (;;)
    {
        const char *found_pos = (const char *)MY_COMPANY_MY_COMPANY_memory_locate(pos, str_len - (pos - str), old_substring, old_substring_len);
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(found_pos == NULL))
        {
        ...
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(FOUNDATIONAL_LIB_safe_add_3_ptr(new_len, diff, replacement_len, &nlen) == 0))
        {
            goto overflow;
        }

        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(nlen == SIZE_MAX))
            goto overflow;
        ...
        if (nlen >= alloc_size)
        {
            ...
            char *new_result = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_REALLOC(result, alloc_size);
            if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_result == NULL))
            {
                MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(replacement);
                goto error;
            }
            result = new_result;
        }
 ...
 *
 * This function duplicates a formatted string created using MY_COMPANY_MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PRINTF-style
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PRINTF_FUNC
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_dup_format(const char *format, ...)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(format);

    MY_COMPANY_FOUNDATIONAL_LIB_VA_LIST args;
    MY_COMPANY_FOUNDATIONAL_LIB_VA_START(args, format);

    /* Determine the length of the formatted string */
    const int len = MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_VSNPRINTF(NULL, 0, format, args);

    MY_COMPANY_FOUNDATIONAL_LIB_VA_END(args);

    if (len == -1)
        goto memory_error;

    /* Would-be Overflow */
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(sizeof(int) >= sizeof(size_t) && (size_t)len == SIZE_MAX))
        goto memory_error;

    /* Allocate memory for the formatted string */
    char *result;

    result = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(len + sizeof("")); /* Safe */
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(result == NULL))
        goto memory_error;

    MY_COMPANY_FOUNDATIONAL_LIB_VA_START(args, format);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_VSNPRINTF(result, len + 1, format, args) == -1)
    {
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(result);
        MY_COMPANY_FOUNDATIONAL_LIB_VA_END(args);
        goto memory_error;
 ...
 *   MY_COMPANY_map_ints(my_array, 5, square_transform);
 *   // After the call, my_array will be {1, 4, 9, 16, 25}
 * @endcode
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_map_ints(int *array, size_t size, int (*transform)(int))
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
 ...
 *   // Example usage:
 *   int my_array[] = {1, 2, 3, 4, 5};
 *   int result = MY_COMPANY_reduce_ints(my_array, 5, add_operation);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_reduce_ints(int *array, size_t size, int (*operation)(int, int))
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
 ...
 * satisfy the condition size_t num_filtered = MY_COMPANY_filter_ints(my_array, 5,
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_filter_ints(int *source, size_t source_size, int *destination, int (*condition)(int))
{
 ...
 *   // Example usage:
 *   int my_array[] = {1, 2, 3, 4, 5};
 *   MY_COMPANY_map(my_array, 5, sizeof(int), increment_transform);
 *   // After the call, my_array will be {2, 3, 4, 5, 6}
 * @endcode
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_map(void *array, size_t size, size_t elem_size, void (*transform)(void *))
{
 ...
 *   int my_array[] = {1, 2, 3, 4, 5};
 *   int result = 0;
 *   MY_COMPANY_reduce(my_array, 5, sizeof(int), &result, sum_operation);
 *   // After the call, result will be the sum of elements: 1 + 2 + 3 + 4 + 5 =
 * 15
 * @endcode
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_reduce(void *array, size_t size, size_t elem_size, void *result, void (*operation)(void *, void *))
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(result);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(operation);
 ...
 *
 * size_t result_size;
 * size_t *result = (size_t *)MY_COMPANY_list_comprehension(input, input_size,
 ...
 *
 * size_t result_size;
 * char **result = (char **)MY_COMPANY_list_comprehension(words, words_size, sizeof(char
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void *MY_COMPANY_list_comprehension(const void *input_array, size_t array_size, size_t elem_size, void (*transform_func)(void *value), int (*filter_func)(void *value), size_t *result_size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(input_array);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(transform_func);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(filter_func);

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(result_size);

    // MY_COMPANY_Set result size to 0 first thing.
    *result_size = 0;
    ...
    void *result = MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(alloc_size);
    ...
    for (size_t i = 0; i < array_size; ++i)
    {
        ...
        if (filter_func((void *)((char *)input_array + i * elem_size)))
        {
            ...
            MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MEMCPY(addr, (char *)input_array + (i * elem_size), elem_size); /* Safe. */
            transform_func(addr);
            ++(*result_size);
        }
    }
     ...
     */
    char *new_result = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_REALLOC(result, array_size * (*result_size)); /* Safe. */
...
/* For MY_COMPANY_Set */
struct MY_COMPANY_SetKey
{
    char *key;
    struct MY_COMPANY_SetKey *next;
};

struct MY_COMPANY_Dict
{
    struct MY_COMPANY_DictKeyValue **table;
    size_t capacity;
    size_t size;
};
...
struct MY_COMPANY_Set
{
    struct MY_COMPANY_SetKey **table;
    size_t capacity;
    size_t size;
};

/**  MY_COMPANY_Dict */
struct MY_COMPANY_DictKeyValue
{
    char *key;
    void *value;
    struct MY_COMPANY_DictKeyValue *next;
};
/* MY_COMPANY_FrozenDict struct */
struct MY_COMPANY_FrozenDict
{
    struct MY_COMPANY_DictKeyValue **table;
    size_t capacity;
...
/* MY_COMPANY_Sets */
typedef struct MY_COMPANY_FrozenSet MY_COMPANY_FrozenSet;
typedef struct MY_COMPANY_Set MY_COMPANY_Set;

/* MY_COMPANY_Dicts */
typedef struct MY_COMPANY_Dict MY_COMPANY_Dict;
typedef struct MY_COMPANY_FrozenDict MY_COMPANY_FrozenDict;

#if MY_COMPANY_FOUNDATIONAL_LIB_THREAD_FUNCTIONS_ENABLED
#include <threads.h>
 ...
 * MY_COMPANY_list_comprehension_multithreaded()
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_FOUNDATIONAL_LIB_list_comprehension_worker(void *data)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(data);
    ...
    *thread_data->result_size = 0;
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(mul == 0)) // Overflow
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return -1;
    }

    void *buffer = MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(mul);

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(buffer == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return -1;
    }
    ...
    for (size_t i = thread_data->start_index; i < thread_data->end_index; ++i)
    {
        ...
        if (thread_data->filter_func((void *)((char *)thread_data->input_array + i * thread_data->elem_size)))
        {
            ...
            MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MEMCPY((char *)buffer + (*thread_data->result_size) * thread_data->elem_size, (char *)thread_data->input_array + i * thread_data->elem_size, thread_data->elem_size); /* Safe. */
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void *MY_COMPANY_list_comprehension_multithreaded(const void *input_array, size_t array_size, size_t elem_size, void (*transform_func)(void *value), int (*filter_func)(void *value), size_t *result_size, size_t thread_count)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(input_array);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(transform_func);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(filter_func);
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(thread_count == 0))
    {
    ...
    *result_size = 0;
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(alloc_size_for_result == 0))
    {
        /* Handle overflow error. */
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    ...
    /* Allocate memory for the result array */
    void *result = MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(alloc_size_for_result);
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(alloc_size_for_thread_result_sizes == 0))
    {
        /* Handle overflow error. */
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(result);
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
    ...
    size_t *thread_result_sizes = (size_t *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(alloc_size_for_thread_result_sizes);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(thread_result_sizes == NULL))
    {
        // Handle memory allocation error
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(result);
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(alloc_size_for_threads == 0))
    {
        /* Handle overflow error. */
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(result);
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(thread_result_sizes);
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }

    // Initialize thread data
    thrd_t *threads = (thrd_t *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(alloc_size_for_threads);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(threads == NULL))
    {
        // Handle memory allocation error
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(result);
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(thread_result_sizes);
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(alloc_size_for_thread_data == 0))
    {
        /* Handle overflow error. */
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(result);
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(thread_result_sizes);
    ...
    struct ThreadData *thread_data = (struct ThreadData *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(alloc_size_for_thread_data);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(thread_data == NULL))
    {
    cannot_allocate_or_create:
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(result);
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(thread_result_sizes);

        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(threads);
    ...
    for (size_t i = 0; i < thread_count; ++i)
    {
        ...
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(ret == 0))
        ...
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(thrd_create(&threads[i], MY_COMPANY_FOUNDATIONAL_LIB_list_comprehension_worker, (void *)&thread_data[i]) != thrd_success))
    ...
    for (size_t i = 0; i < thread_count; ++i)
    {
        ...
        // The thread failed.
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(return_value_of_thread == -1))
            goto cannot_allocate_or_create;
    }
    ...
    for (size_t i = 0; i < thread_count; ++i)
    {
        MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MEMCPY((char *)result + total_result_size * elem_size, thread_data[i].result, thread_result_sizes[i] * elem_size); /* Safe. */
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(thread_data[i].result);
    ...
    *result_size = total_result_size;
    ...
    MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(thread_result_sizes);
    MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(thread_data);
    MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(threads);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void *MY_COMPANY_reject_array(const void *source, size_t source_size, size_t elem_size, int (*condition)(const void *), size_t *result_size)
{
    ...
    *result_size = 0;
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(mul == 0))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }

    void *result = MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(mul);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(result == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    ...
    for (size_t i = 0; i < source_size; ++i)
    {
        ...
        if (!condition(current_source))
        {
            ...
            MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MEMCPY(current_result, current_source, elem_size);
            result_index++;
        }
    }

    /* MY_COMPANY_Set the result size */
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void *MY_COMPANY_select_array(const void *source, size_t source_size, size_t elem_size, int (*condition)(const void *), size_t *result_size)
{
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void *MY_COMPANY_replicate(const void *source, size_t source_size, size_t elem_size, size_t repetitions)
{
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(elem_times_source == 0))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(result_total_size == 0))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }
    ...
    /* Allocate memory for the result array */
    void *result = MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(result_total_size);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(result == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    ...
    for (size_t i = 0; i < repetitions; ++i)
    {
        ...
        MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MEMCPY((char *)result + (i * elem_times_source), source, elem_times_source); /* Safe. */
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_string_to_lowercase(char *string)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(string);

    char *new_str = MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_STRDUP(string);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_string_to_uppercase(char *string)
{
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_is_string_upper(const char *string)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(string);
    while (*string)
    {
        if (!MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ISUPPER(*string))
        {
            return 0;
        }
        ++string;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_is_string_lower(const char *string)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(string);

    while (*string)
    {
        if (!MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ISLOWER(*string))
        {
            return 0;
        }
        ++string;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_is_string_alpha(const char *string)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(string);
    while (*string)
    {
        if (!MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ISALNUM(*string))
        {
            return 0;
        }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_is_string_digit(const char *string)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(string);
    while (*string)
    {
        if (!MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ISDIGIT(*string))
        {
            return 0;
        }
        ++string;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_is_string_space(const char *string)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(string);

    while (*string)
    {
        if (!MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ISSPACE(*string))
        {
            return 0;
        }
        ++string;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_is_string_printable(const char *string)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(string);
    while (*string)
    {
        if (!MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ISPRINT(*string))
        {
            return 0;
        }
        ++string;
 ...
 * if (MY_COMPANY_is_array_digit(myArray, 3)) {
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_is_array_digit(const char **array, size_t size)
{
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_is_array_upper(const char **array, size_t size)
{
    ...
    for (size_t i = 0; i < size; ++i)
    {
        ...
        while (*str)
        {
            if (!MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ISUPPER(*str))
            {
                return 0;
            }
            ++str;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_is_array_lower(const char **array, size_t size)
{
    ...
    for (size_t i = 0; i < size; ++i)
    {
        ...
        while (*str)
        {
            if (!MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ISLOWER(*str))
            {
                return 0;
            }
            ++str;
 ...
 * char **result_array;
 * size_t result_size;
 * int status = MY_COMPANY_string_array_uniq(input_array, 5, &result_array, &result_size);
 * if (!status) {
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_string_array_uniq(const char **array, size_t size, char ***output, size_t *output_size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    ...
    *output = (char **)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(alloc_size);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(*output == NULL))
    {
    ...
    // MY_COMPANY_Set the output size
    *output_size = count;
 ...
 * char **result_array;
 * size_t result_size;
 * int status = MY_COMPANY_string_array_uniq_adjacent(input_array, 7, &result_array, &result_size);
 * if (!status) {
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_string_array_uniq_adjacent(const char **first_array, size_t size, char ***new_array, size_t *new_size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(first_array);

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(new_array);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(new_size);
    ...
    *new_array = (char **)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(alloc_size);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(*new_array == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return -1;
    ...
    for (size_t i = 0; i < size; ++i)
    {
        if (i == 0 || MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRCMP(first_array[i], first_array[i - 1]) != 0)
        {
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_concatenate_three_strings(const char *str1, const char *str2, const char *str3)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str1);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str2);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str3);

    const char *strs[3] = {str1, str2, str3};

    return MY_COMPANY_concatenate_string_array(strs, 3);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_concatenate_four_strings(const char *str1, const char *str2, const char *str3, const char *str4)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str1);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str2);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str3);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str4);

    const char *strs[4] = {str1, str2, str3, str4};

    return MY_COMPANY_concatenate_string_array(strs, 4);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_concatenate_five_strings(const char *str1, const char *str2, const char *str3, const char *str4, const char *str5)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str1);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str2);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str3);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str4);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str5);

    const char *strs[5] = {str1, str2, str3, str4, str5};

    return MY_COMPANY_concatenate_string_array(strs, 5);
}
...
#ifdef _WIN32
#define MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_DIR_SEPARATOR '\\'
#else
#define MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_DIR_SEPARATOR '/'
#endif
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_map_filesystem_files_as_strings(const char *directory, char *(*map_function)(const char *file_string_data, size_t string_size))
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(directory);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(map_function);

#ifdef _WIN32
    WIN32_FIND_DATA findFileData;
    HANDLE hFind = FindFirstFile(directory, &findFileData);

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(hFind == INVALID_HANDLE_VALUE))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return -1;
    }
    ...
    do
    {
        if (!(findFileData.dwFileAttributes & FILE_ATTRIBUTE_DIRECTORY))
        {
            ...
            _stprintf(fullFilePath, _T("%s%c%s"), directory, MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_DIR_SEPARATOR, findFileData.cFileName);

            file_data = MY_COMPANY_read_file_into_string(fullFilePath, &size);
            if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(file_data == NULL))
            {
            ...
            if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(MY_COMPANY_write_file(fullFilePath, new_str) == -1))
            {
                // No need to re-die aggressively.
                MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(file_data);
                MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE((char *)new_str);
                FindClose(hFind); // No need to error check here because there already is an error.
                return -1;
            }
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(FindClose(hFind) == 0))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return -1;
    }
    ...
    while ((entry = readdir(dir)) != NULL)
    {
        ...
        { // Regular file
            ...
            MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_SNPRINTF(fullFilePath, PATH_MAX, "%s%c%s", directory, MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_DIR_SEPARATOR, entry->d_name);
            ...
            // Write the result to disk
            if (MY_COMPANY_write_file(fullFilePath, new_str) == -1)
            {
                // No need to re-die aggressively.
                MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(file_data);
                MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE((char *)new_str);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_filter_filesystem_files_as_strings(const char *directory, int (*filter_function)(const char *filename))
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(directory);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(filter_function);
#ifdef _WIN32
    WIN32_FIND_DATA findFileData;
    HANDLE hFind = FindFirstFile(directory, &findFileData);
    ...
    do
    {
        if (!(findFileData.dwFileAttributes & FILE_ATTRIBUTE_DIRECTORY) && !filter_function(findFileData.cFileName))
        {
            ...
            if (MY_COMPANY_remove_file(fullFilePath) == -1)
            {
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_reduce_filesystem_files_as_strings(const char *directory, const char *out_file, char *(*reduce_function)(char *value1, ...))
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(directory);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(out_file);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(reduce_function);
#ifdef _WIN32
    WIN32_FIND_DATA findFileData;
    HANDLE hFind = FindFirstFile(directory, &findFileData);
    ...
    do
    {
        if (!(findFileData.dwFileAttributes & FILE_ATTRIBUTE_DIRECTORY) && findFileData.dwFileAttributes & FILE_ATTRIBUTE_NORMAL)
        {
            ...
            value = MY_COMPANY_read_file_into_string(fullFilePath, &size);
            if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(value == NULL))
            {
                // No need to re-die aggressively.
            ...
            if (last_value)
            {
                MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(last_value);
            }

            MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(value);
            last_value = new_value;

            if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(MY_COMPANY_remove_file(fullFilePath) == -1))
            {
                MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
                return NULL;
            }
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(MY_COMPANY_write_file(out_file, value) == -1))
    {
        /* No need to re-die aggressively. */
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(last_value);
        return NULL;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_dict_destructor(struct MY_COMPANY_Dict *dict)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(dict);

    for (size_t i = 0; i < dict->capacity; ++i)
    {
        struct MY_COMPANY_DictKeyValue *current_pair = dict->table[i];
        while (current_pair != NULL)
        {
            struct MY_COMPANY_DictKeyValue *next_pair = current_pair->next;
            MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(current_pair->key);
            MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(current_pair);
            current_pair = next_pair;
        }
    }
    MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(dict->table);
    MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(dict);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC size_t MY_COMPANY_dict_hash(const char *key, size_t capacity)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(key);
...
/**
 * @brief Reserves additional space in a MY_COMPANY_Dictionary for anticipated new
 * elements.
 *
 ...
 *
 * @param dict A pointer to the MY_COMPANY_Dict instance for which space is to be reserved.
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_dict_reserve_more(struct MY_COMPANY_Dict *dict, size_t number_of_new_elements_max_one_is_expecting)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(dict);

    const size_t new_capacity = FOUNDATIONAL_LIB_safe_add_2(dict->capacity, number_of_new_elements_max_one_is_expecting);

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_capacity == 0))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return -1;
    }
    ...
    struct MY_COMPANY_DictKeyValue **new_table = (struct MY_COMPANY_DictKeyValue **)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_CALLOC(new_capacity, sizeof(struct MY_COMPANY_DictKeyValue *));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_table == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return -1;
    }
    ...
    for (size_t i = 0; i < dict->capacity; ++i)
    {
        ...
        {
            struct MY_COMPANY_DictKeyValue *next_pair = current_pair->next;
            const size_t new_index = MY_COMPANY_dict_hash(current_pair->key, new_capacity);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_dict_resize(struct MY_COMPANY_Dict *dict)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(dict);

    const size_t new_capacity = FOUNDATIONAL_LIB_REALLOC_REALLOCATION_ALGORITHM(dict->capacity);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_capacity == 0)) // Overflow.
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return -1;
    }
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_table == NULL))
    {
        MY_COMPANY_dict_destructor(dict);
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return -1;
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_dict_del_key(struct MY_COMPANY_Dict *dict, const char *key)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(dict);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(key);
    const size_t index = MY_COMPANY_dict_hash(key, dict->capacity);

    struct MY_COMPANY_DictKeyValue *current = dict->table[index];
    struct MY_COMPANY_DictKeyValue *prev = NULL;

    while (current != NULL)
    {
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRCMP(current->key, key) == 0)
        {
            ...
            /* Free memory */
            MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(current->key);
            MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(current);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_dict_add(struct MY_COMPANY_Dict *dict, const char *key, void *value)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(dict);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(key);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(value);
    if ((double)dict->size / dict->capacity > MY_COMPANY_FOUNDATIONAL_LIB_HASH_LOAD_FACTOR_THRESHOLD)
    {
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(MY_COMPANY_dict_resize(dict) == -1))
        {
    ...
    struct MY_COMPANY_DictKeyValue *new_pair = (struct MY_COMPANY_DictKeyValue *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(sizeof(struct MY_COMPANY_DictKeyValue));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_pair == NULL))
    {
    ...
    new_pair->key = MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_STRDUP(key);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_pair->key == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(new_pair);
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return -1;
    }
    ...
    {
        struct MY_COMPANY_DictKeyValue *current = new_pair->next; // First one
        struct MY_COMPANY_DictKeyValue *prev = new_pair;          // New one
 ...
 * the dictionary. If such differentiation is needed, use MY_COMPANY_dict_get_check(dict,
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void *MY_COMPANY_dict_get(struct MY_COMPANY_Dict *dict, const char *key)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(dict);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(key);
    const size_t index = MY_COMPANY_dict_hash(key, dict->capacity);
    struct MY_COMPANY_DictKeyValue *current_pair = dict->table[index];

    while (current_pair != NULL)
    {
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRCMP(current_pair->key, key) == 0)
        {
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void *MY_COMPANY_dict_get_check(struct MY_COMPANY_Dict *dict, const char *key, int *key_is_in_dict)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(dict);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(key);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(key_is_in_dict);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_frozen_dict_destructor(struct MY_COMPANY_FrozenDict *dict)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(dict);
    MY_COMPANY_dict_destructor((struct MY_COMPANY_Dict *)dict);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC struct MY_COMPANY_FrozenDict *MY_COMPANY_frozen_dict_new_instance(size_t num_pairs, ...)
{
    struct MY_COMPANY_FrozenDict *frozen_dict = (struct MY_COMPANY_FrozenDict *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(sizeof(struct MY_COMPANY_FrozenDict));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(frozen_dict == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }

    frozen_dict->capacity = num_pairs * MY_COMPANY_FOUNDATIONAL_LIB_FROZEN_INITIALIZATION_SIZE_MULTIPLIER;
    frozen_dict->size = 0;
    frozen_dict->table = (struct MY_COMPANY_DictKeyValue **)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_CALLOC(MY_COMPANY_FOUNDATIONAL_LIB_HASH_INITIAL_CAPACITY, sizeof(struct MY_COMPANY_DictKeyValue *));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(frozen_dict->table == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(frozen_dict);
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }

    MY_COMPANY_FOUNDATIONAL_LIB_VA_LIST args;
    MY_COMPANY_FOUNDATIONAL_LIB_VA_START(args, num_pairs);
    ...
    for (size_t i = 0; i < num_pairs; ++i)
    {
        ...
        key = MY_COMPANY_FOUNDATIONAL_LIB_VA_ARG(args, char *);
        value = MY_COMPANY_FOUNDATIONAL_LIB_VA_ARG(args, void *);

        MY_COMPANY_dict_add((struct MY_COMPANY_Dict *)frozen_dict, key, value);
    }

    MY_COMPANY_FOUNDATIONAL_LIB_VA_END(args); // Clean up the va_list
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void *MY_COMPANY_frozen_dict_get(struct MY_COMPANY_FrozenDict *dict, const char *key)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(dict);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(key);
    const size_t index = MY_COMPANY_dict_hash(key, dict->capacity);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void *MY_COMPANY_frozen_dict_get_check(struct MY_COMPANY_FrozenDict *dict, const char *key, int *key_is_in_dict)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(dict);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(key);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(key_is_in_dict);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_dict_iter(struct MY_COMPANY_Dict *dict, void (*callback)(char *key, void *value))
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(dict);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(callback);
    ...
    for (size_t i = 0; i < dict->capacity; ++i)
    {
        struct MY_COMPANY_DictKeyValue *current = dict->table[i];
...
/**
 * @brief Iterates through the key-value pairs in the MY_COMPANY_FrozenDict, applying a
 * callback function.
 *
 * This function iterates through the key-value pairs in the provided MY_COMPANY_FrozenDict
 * and applies the specified callback function to each pair. The callback
 * function takes a key and a value as parameters and is applied for each
 * element in the MY_COMPANY_FrozenDict.
 *
 * @param dict A pointer to the MY_COMPANY_FrozenDict instance.
 * @param callback A function pointer to the callback function taking a key and
 * a value as parameters.
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_frozen_dict_iter(struct MY_COMPANY_FrozenDict *frozen_dict, void (*callback)(char *key, void *value))
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(frozen_dict);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(callback);
    for (size_t i = 0; i < frozen_dict->capacity; ++i)
    {
        struct MY_COMPANY_DictKeyValue *current = frozen_dict->table[i];
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC size_t MY_COMPANY_dict_size(struct MY_COMPANY_Dict *dict)
{
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC size_t MY_COMPANY_frozen_dict_size(struct MY_COMPANY_FrozenDict *dict)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(dict);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_dict_to_array(struct MY_COMPANY_Dict *dict, char ***keys, void ***values, size_t *size_of_keys_and_values)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(dict);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(keys);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(values);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(size_of_keys_and_values);

    const size_t alloc_size1 = FOUNDATIONAL_LIB_safe_mul(dict->size, sizeof(char *));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(alloc_size1 == 0))
        goto overflow;
    size_t alloc_size2;

    alloc_size2 = FOUNDATIONAL_LIB_safe_mul(dict->size, sizeof(void *));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(alloc_size2 == 0))
        goto overflow;

    *keys = (char **)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(alloc_size1);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(*keys == NULL))
        goto error_handler;

    *values = (void **)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(alloc_size2);

    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(*values == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(*keys);
        *keys = NULL;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC size_t MY_COMPANY_frozen_dict_to_array(struct MY_COMPANY_FrozenDict *dict, char ***keys, void ***values, size_t *size_of_keys_and_values)
{
 ...
 *
 * This function serves as the destructor for an array of MY_COMPANY_Dict keys, freeing the
 ...
 *
 * This function serves as the destructor for an array of MY_COMPANY_Dict values, freeing
...
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(values);
    MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(values);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_dict_to_string(struct MY_COMPANY_Dict *dict, int pointer_or_string) /* 0 = pointer, 1 = string */
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(dict);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(pointer_or_string == 0 || pointer_or_string == 1);
    ...
    for (size_t i = 0; i < dict->capacity; ++i)
    {
        ...
        while (current_pair != NULL)
        {
             ...
             * pair */
            total_length += MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRLEN(current_pair->key) + 2; // 2 for ": "
            if (pointer_or_string == 0)
            {
                total_length += MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_SNPRINTF(NULL, 0, "%p",
                                                          current_pair->value); // Calculate the length of the value string
            }
            else
            {
                total_length += MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_SNPRINTF(NULL, 0, "%s",
    ...
    char *result = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(total_length + sizeof("")); /* Should be Safe. */
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(result == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    ...
    for (size_t i = 0; i < dict->capacity; ++i)
    {
        ...
        while (current_pair != NULL)
        {
            ...
            if (pointer_or_string == 0)
            {
                index += MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_SNPRINTF(result + index, total_length - index, "%s: %p", current_pair->key, current_pair->value);
            }
            else if (pointer_or_string == 1)
            {
                index += MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_SNPRINTF(result + index, total_length - index, "%s: %s", current_pair->key, (char *)current_pair->value);
            }
            current_pair = current_pair->next;
...
/**
 * @brief Converts a MY_COMPANY_FrozenDict (frozen dictionary) to a string representation.
 *
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_frozen_dict_to_string(struct MY_COMPANY_FrozenDict *dict, int pointer_or_string) /* 0 = pointer, 1 = string */
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(dict);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(pointer_or_string == 0 || pointer_or_string == 1);
    /* Allocate memory for the string representation */
    ...
    // Add 1 for the null-terminator, at least 3 chars additional
    char *result = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(total_length + sizeof("")); /* Safe. */
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(result == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
...
/**
 * @brief The destructor for a MY_COMPANY_Set.
 *
 * This function sets the destructor for a MY_COMPANY_Set data structure.
 *
 * @param set The MY_COMPANY_Set data structure.
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_set_destructor(struct MY_COMPANY_Set *set)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(set);

    for (size_t i = 0; i < set->capacity; ++i)
    {
        struct MY_COMPANY_SetKey *current_key = set->table[i];
        while (current_key != NULL)
        {
            struct MY_COMPANY_SetKey *next_key = current_key->next;
            MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(current_key->key);
            MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(current_key);
            current_key = next_key;
        }
    }
    MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(set->table);
    MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(set);
}

/**
 * @brief Creates a new instance of a MY_COMPANY_Set.
 *
 * This function creates a new instance of a MY_COMPANY_Set data structure.
 *
 * @return Returns a pointer to the new MY_COMPANY_Set instance.
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC struct MY_COMPANY_Set *MY_COMPANY_set_new_instance(void)
{
    struct MY_COMPANY_Set *set = (struct MY_COMPANY_Set *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(sizeof(struct MY_COMPANY_Set));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(set == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }

    set->capacity = MY_COMPANY_FOUNDATIONAL_LIB_HASH_INITIAL_CAPACITY;
    set->size = 0;
    set->table = (struct MY_COMPANY_SetKey **)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_CALLOC(MY_COMPANY_FOUNDATIONAL_LIB_HASH_INITIAL_CAPACITY, sizeof(struct MY_COMPANY_SetKey *));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(set->table == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(set);
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC size_t MY_COMPANY_set_hash(const char *key, size_t capacity)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(key);
    size_t hash = 5381; // Initial hash value
    int c;              // Variable to store the current character
...
/**
 * @brief Resizes a MY_COMPANY_Set data structure.
 *
 * This function resizes a MY_COMPANY_Set data structure.
 *
 * @param dict The MY_COMPANY_Set data structure to resize.
 * @return Returns 1 on success, 0 on failure.
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_set_resize(struct MY_COMPANY_Set *set)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(set);
    ...
    /* Either calloc or realloc would be ideal here, but, if the block is large,
       then calloc might be better because there might be a cleared block of
       memory that is very large that is readily available. */
    struct MY_COMPANY_SetKey **new_table = (struct MY_COMPANY_SetKey **)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_CALLOC(new_capacity, sizeof(struct MY_COMPANY_SetKey *));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_table == NULL))
    {
        MY_COMPANY_set_destructor(set);
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return -1;
    }
    ...
    for (size_t i = 0; i < set->capacity; ++i)
    {
        ...
        {
            struct MY_COMPANY_SetKey *next_key = current_key->next;
            const size_t new_index = MY_COMPANY_set_hash(current_key->key, new_capacity);
...
/**
 * @brief Deletes a key from a MY_COMPANY_Set.
 *
 * This function deletes a key from a MY_COMPANY_Set data structure.
 *
 * @param set The MY_COMPANY_Set data structure.
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_set_del_key(struct MY_COMPANY_Set *set, const char *key)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(set);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(key);

    const size_t index = MY_COMPANY_set_hash(key, set->capacity);

    struct MY_COMPANY_SetKey *current = set->table[index];
    struct MY_COMPANY_SetKey *prev = NULL;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_set_add(struct MY_COMPANY_Set *set, const char *key)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(set);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(key);

    if ((double)set->size / set->capacity > MY_COMPANY_FOUNDATIONAL_LIB_HASH_LOAD_FACTOR_THRESHOLD)
    {
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(MY_COMPANY_set_resize(set) == -1))
        {
    ...
    struct MY_COMPANY_SetKey *new_set_key = (struct MY_COMPANY_SetKey *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(sizeof(struct MY_COMPANY_SetKey));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_set_key == NULL))
    {
        /* Keep the old key if there was one. */
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return -1;
    ...
    new_set_key->key = MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_STRDUP(key);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_set_key->key == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(new_set_key);
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return -1;
    }
    ...
    {
        struct MY_COMPANY_SetKey *current = new_set_key->next; // First one
        struct MY_COMPANY_SetKey *prev = new_set_key;          // New one
        /* Traverse the linked list to check for duplicates */
        do
        {
...
/**
 * @brief Reserves additional space in a MY_COMPANY_Set for anticipated new elements.
 *
 * This function reserves additional space in the provided MY_COMPANY_Set's internal hash
 ...
 * rehash of the MY_COMPANY_Set, but it will only happen (ideally) once, if you
 * accurately predict the future size of the MY_COMPANY_Set.
 *
 * @param set A pointer to the MY_COMPANY_Set instance for which space is to be reserved.
 * @param number_of_new_elements_max_one_is_expecting The anticipated number of
 * new elements (above the current capacity).
 *
 * @return Returns 0 on success, -1 on failure.
...
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_set_reserve_more(struct MY_COMPANY_Set *set, size_t number_of_new_elements_max_one_is_expecting)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(set);
...
/**
 * @brief Checks if a key is in a MY_COMPANY_Set.
 *
 * This function checks if a key is present in a MY_COMPANY_Set.
 *
 * @param set The MY_COMPANY_Set data structure.
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_set_in(struct MY_COMPANY_Set *set, const char *key)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(set);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(key);

    const size_t index = MY_COMPANY_set_hash(key, set->capacity);
    struct MY_COMPANY_SetKey *current_key = set->table[index];

    while (current_key != NULL)
    {
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRCMP(current_key->key, key) == 0)
        {
            return 1;
        }
...
/**
 * @brief The destructor for a Frozen MY_COMPANY_Set.
 *
 * This function sets the destructor for a MY_COMPANY_Set data structure.
 *
 * @param dict The Frozen MY_COMPANY_Set data structure.
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_frozen_set_destructor(struct MY_COMPANY_FrozenSet *frozen_set)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(frozen_set);
    MY_COMPANY_set_destructor((struct MY_COMPANY_Set *)frozen_set);
}

/**
 * @brief Creates a new instance of a MY_COMPANY_FrozenSet.
 *
 * This function creates a new instance of a MY_COMPANY_FrozenSet data structure.
 *
 * @param num_args The number of arguments provided.
 * @param ... The variable arguments representing keys.
 * @return Returns a pointer to the new MY_COMPANY_FrozenSet instance.
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC struct MY_COMPANY_FrozenSet *MY_COMPANY_frozen_set_new_instance(size_t num_args, ...)
{
    struct MY_COMPANY_FrozenSet *frozen_set = (struct MY_COMPANY_FrozenSet *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(sizeof(struct MY_COMPANY_FrozenSet));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(frozen_set == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }

    frozen_set->capacity = num_args * MY_COMPANY_FOUNDATIONAL_LIB_FROZEN_INITIALIZATION_SIZE_MULTIPLIER;
    frozen_set->size = 0;
    frozen_set->table = (struct MY_COMPANY_SetKey **)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_CALLOC(MY_COMPANY_FOUNDATIONAL_LIB_HASH_INITIAL_CAPACITY, sizeof(struct MY_COMPANY_SetKey *));
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(frozen_set->table == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(frozen_set);
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
    }

    MY_COMPANY_FOUNDATIONAL_LIB_VA_LIST args;
    MY_COMPANY_FOUNDATIONAL_LIB_VA_START(args, num_args);
    ...
    for (size_t i = 0; i < num_args; ++i)
    {
        ...
        key = MY_COMPANY_FOUNDATIONAL_LIB_VA_ARG(args, char *);
        MY_COMPANY_set_add((struct MY_COMPANY_Set *)frozen_set, key);
    }
...
/**
 * @brief Checks if a key is in a MY_COMPANY_FrozenSet.
 *
 * This function checks if a key is present in a MY_COMPANY_FrozenSet data structure.
 *
 * @param set The MY_COMPANY_FrozenSet data structure.
 * @param key The key to check.
 * @return Returns 1 if the key is present, 0 otherwise.
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_frozen_set_in(struct MY_COMPANY_FrozenSet *set, const char *key)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(set);
...
/**
 * @brief Iterates over a MY_COMPANY_Set and applies a callback to each key.
 *
 * This function iterates over a MY_COMPANY_Set data structure and applies a callback to each key.
 *
 * @param set The MY_COMPANY_Set data structure.
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_set_iter(struct MY_COMPANY_Set *set, void (*callback)(char *key))
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(set);
    ...
    for (size_t i = 0; i < set->capacity; ++i)
    {
        struct MY_COMPANY_SetKey *current = set->table[i];
...
/**
 * @brief Returns the size of a MY_COMPANY_Set.
 *
 * This function returns the size of a MY_COMPANY_Set data structure.
 *
 * @param set The MY_COMPANY_Set data structure.
 * @return Returns the size of the MY_COMPANY_Set.
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC size_t MY_COMPANY_set_size(struct MY_COMPANY_Set *set)
{
...
/**
 * @brief Returns the size of a MY_COMPANY_FrozenSet.
 *
 * This function returns the size of a MY_COMPANY_FrozenSet data structure.
 *
 * @param set The MY_COMPANY_FrozenSet data structure.
 * @return Returns the size of the MY_COMPANY_FrozenSet.
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_WARN_UNUSED_RESULT
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC size_t MY_COMPANY_frozen_set_size(struct MY_COMPANY_FrozenSet *set)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(set);
    return set->size;
}
...
/**
 * @brief Converts a MY_COMPANY_Set to an array of keys.
 *
 * This function converts a MY_COMPANY_Set data structure to an array of keys. The resulting array
 * is allocated dynamically and needs to be freed by the caller using MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE.
 *
 * @param set The MY_COMPANY_Set data structure.
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_set_to_array(struct MY_COMPANY_Set *set, char ***keys, size_t *size_of_keys)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(set);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(keys);

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(size_of_keys);
    ...
    *keys = (char **)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(alloc_size1);
    ...
    {
        struct MY_COMPANY_SetKey *current_pair = set->table[i];
        while (current_pair != NULL)
        {
            (*keys)[index] = (current_pair->key);
...
/**
 * @brief Converts a MY_COMPANY_FrozenSet to an array of keys.
 *
 * This function converts a MY_COMPANY_FrozenSet data structure to an array of keys.
 *
 * @param set The MY_COMPANY_FrozenSet data structure.
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_frozen_set_to_array(struct MY_COMPANY_FrozenSet *set, char ***keys, size_t *size_of_keys)
{
...
/**
 * @brief Deletes keys from a MY_COMPANY_Set.
 *
 * This function deletes keys from a MY_COMPANY_Set data structure.
 *
 * @param keys The keys to delete.
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_set_del_keys(char **keys) { MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(keys); }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_set_to_string(struct MY_COMPANY_Set *set)
{
    ...
    for (size_t i = 0; i < set->capacity; ++i)
    {
        ...
        while (current_key != NULL)
        {
            /* Calculate the length of the string representation for each key-value
             * pair */
            total_length += MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRLEN(current_key->key);
            total_length += 2; // 2 for ", "
            current_key = current_key->next;
        }
    }
    ...
    for (size_t i = 0; i < set->capacity; ++i)
    {
        ...
        {
            /* Append the key and value to the string representation */
            index += MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_SNPRINTF(result + index, total_length - index, "%s", current_key->key);
            current_key = current_key->next;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_frozen_set_to_string(struct MY_COMPANY_FrozenSet *frozen_set)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(frozen_set);
    ...
    {
        struct MY_COMPANY_SetKey *current_key = frozen_set->table[i];
        while (current_key != NULL)
        {
            /* Calculate the length of the string representation for each key-value
             * pair */
    ...
    char *result = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(total_length + 1 /* Safe, should not reach SIZE_MAX */);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(result == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
...
/**
 * @brief Deletes keys from a MY_COMPANY_FrozenSet.
 *
 * This function deletes keys from a MY_COMPANY_FrozenSet data structure and frees the memory allocated for the keys.
 *
 * @param keys The keys to delete and free.
 */
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_frozen_set_del_keys(char **keys)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(keys);
    MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(keys);
}
 ...
 * @brief Iterates over a MY_COMPANY_Set and applies a callback to each key.
 *
 * This function iterates over a MY_COMPANY_Set data structure and applies a callback function to each key.
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_frozen_set_iter(struct MY_COMPANY_Set *set, void (*callback)(char *key))
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(set);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(callback);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_is_valid_utf8(const char *str, size_t len)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC const char *MY_COMPANY_sample_strings(const char **strings, size_t size) /* Does not dynamically allocate memory. */
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(strings);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_shuffle_strings_in_place(char **strings, size_t size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(strings);
...
#ifdef _WIN32
        unsigned int rand_val;
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(rand_s(&rand_val) != 0))
        {
            MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
            return -1;
        }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC long MY_COMPANY_rand_number_from_range_inclusive_signed(signed long min, signed long max)
{
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC unsigned long MY_COMPANY_rand_number_from_range_inclusive_unsigned(unsigned long min, unsigned long max)
{
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char *MY_COMPANY_backticks(const char *command, size_t *size)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(command);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(size);

    FILE *pipe = MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_POPEN(command, "r");
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(pipe == NULL))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL; // Indicate error by returning NULL
    }
    ...
    size_t output_size = MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_POPEN_INITIAL_ALLOC_SIZE; // Initial output buffer size
    char *output = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(output_size);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(output == NULL))
    {
    ...
    for (;;)
    {
        const size_t read_size = MY_COMPANY_FOUNDATIONAL_LIB_FREAD(output + total_read, 1, 4096, pipe);

        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(read_size == 0))
        {
            const int error_code = MY_COMPANY_FOUNDATIONAL_LIB_FERROR(pipe);
            if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(error_code))
            {
                MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(output);
                pclose(pipe); // No need to check errors here because things are already
                              // going wrong.
                MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
                return NULL;
        ...
        else if (total_read + read_size + 1 > output_size)
        {
            ...
            if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_realloc_length == 0))
            {
                MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(output);
                MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
                return NULL;
            ...
            if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(output_size == 0)) // Overflow.
            {
                MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
                return NULL;
            }
            char *new_output = (char *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_REALLOC(output, output_size);

            if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(new_output == NULL))
            {
                MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(output);
                pclose(pipe); // No need to check errors here because things are already
                              // going wrong.
    ...
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(ferror(pipe) != 0))
    {
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(output);
    ...
    *size = total_read;
    ...
    // Close the pipe
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(pclose(pipe) != 0)) // Check for errors.
    {
        MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE(output);
        MY_COMPANY_FOUNDATIONAL_LIB_die_aggressively_if_enabled();
        return NULL;
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MALLOC
MY_COMPANY_FOUNDATIONAL_LIB_FUNC char **MY_COMPANY_read_file_into_array(const char *filename, const char *delim, size_t *num_lines)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(filename);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(delim);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(num_lines);
    ...
    *num_lines = 0;
     ...
     * better might be MY_COMPANY_read_file_into_string() with strtok() used
     * to extract the parts you want, or manual code withMY_COMPANY_FOUNDATIONAL_LIB_FREAD().
     *
     * Any which way, this implementation is decent and efficient
     * for many purposes.
     */
    const char *file = MY_COMPANY_read_file_into_string(filename, &size_of_file);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(file == NULL))
    {
        /* MY_COMPANY_read_file_into_string() would already call die_aggressively_if_enabled */

        return NULL;
    }

    char **lines = MY_COMPANY_split(file, num_lines, delim, 0, 1);

    MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_FREE((void *)file);
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(lines == NULL))
    {
        /* MY_COMPANY_split() would already call die_aggressively_if_enabled */
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_char(const char value) { MY_COMPANY_MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PRINTF("%c", value); }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_char_to_stream(const char value, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(stream);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPRINTF(stream, "%c", value);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_double(const double value) { MY_COMPANY_MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PRINTF("%f", value); }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_double_to_stream(const double value, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(stream);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPRINTF(stream, "%f", value);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_float(const float value) { MY_COMPANY_MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PRINTF("%f", value); }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_float_to_stream(const float value, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(stream);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPRINTF(stream, "%f", value);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_int(const int value) { MY_COMPANY_MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PRINTF("%d", value); }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_int_to_stream(const int value, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(stream);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPRINTF(stream, "%d", value);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_long(const long value) { MY_COMPANY_MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PRINTF("%ld", value); }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_long_to_stream(const long value, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(stream);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPRINTF(stream, "%ld", value);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_long_long(const long long value) { MY_COMPANY_MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PRINTF("%lld", value); }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_long_long_to_stream(const long long value, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(stream);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_short(const short value) { MY_COMPANY_MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PRINTF("%hd", value); }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_short_to_stream(const short value, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(stream);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPRINTF(stream, "%hd", value);
}
/**
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_size_t(const size_t value) { MY_COMPANY_MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PRINTF("%zu", value); }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_size_t_to_stream(const size_t value, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(stream);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_string(char *value)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(value);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PRINTF("%s", value);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_string_to_stream(char *value, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(stream);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(value);

    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPRINTF(stream, "%s", value);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_uchar(const unsigned char value) { MY_COMPANY_MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PRINTF("%c", value); }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_uchar_to_stream(const unsigned char value, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(stream);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPRINTF(stream, "%c", value);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_uint(const unsigned int value) { MY_COMPANY_MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PRINTF("%u", value); }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_uint_to_stream(const unsigned int value, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(stream);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPRINTF(stream, "%u", value);
}
/**
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_ulong(const unsigned long value) { MY_COMPANY_MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PRINTF("%lu", value); }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_ulong_to_stream(const unsigned long value, FILE *stream)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(stream);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPRINTF(stream, "%lu", value);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_ushort(const unsigned short value) { MY_COMPANY_MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PRINTF("%hu", value); }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC void MY_COMPANY_print_ushort_to_stream(const unsigned short value, FILE *stream)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(stream);
    MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_FPRINTF(stream, "%hu", value);
}
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC size_t MY_COMPANY_count_occurrences_of_string_in_array(const char **array, const char *string, size_t array_length)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array);
    ...
    for (size_t i = 0; i < array_length; ++i)
    {
        ...
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_STRCMP(array[i], string) == 0)
        {
            ++count;
        }
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC size_t MY_COMPANY_count_occurrences_of_adjacent_data_in_array(const void *array_of_adjacent_values, size_t array_length, const void *memory, size_t memory_length)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array_of_adjacent_values);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(memory_length);
    size_t count = 0;
    ...
    for (size_t i = 0; i < array_length; ++i)
    {
        ...
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MEMCMP(array_of_adjacent_values, memory, memory_length) == 0)
        {
            count++;
        }
    }
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PURE
MY_COMPANY_FOUNDATIONAL_LIB_FUNC size_t MY_COMPANY_count_occurrences_of_data_in_array(const void **array_of_pointers, size_t array_length, const void *memory, size_t memory_length)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(array_of_pointers);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(memory);
    ...
    {
        // Dereferences each pointer in the array and compare memory_length bytes.
        if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_MEMCMP(array_of_pointers[i], memory, memory_length) == 0)
        {
            count++;
        }
    }
...
#define MY_COMPANY_FOUNDATIONAL_LIB_DEFAULT_USER_AGENT "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36"
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC size_t MY_COMPANY_FOUNDATIONAL_LIB_libcurl_write_callback(char *data, size_t n, size_t l, void *userp)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(data);

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(userp);
    struct StringData
    {
        char *string;
    ...
    MY_COMPANY_append_string_to_string(&string->string, &string->size, &string->alloc_size, data, both);
    ...
    if (string->byte_max_cutoff != 0 && string->size >= string->byte_max_cutoff)
    {
        ...
        /* MY_COMPANY_MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_PRINTF("%zu.size >= %zu.byte_max_cutoff\n", string->size,
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_download_website(const char *website, char **string, size_t *size, size_t *str_alloc_size, size_t byte_max_cutoff, const char *user_agent)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(website);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(string);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(size);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(str_alloc_size);

    CURL *curl = curl_easy_init();
    if (MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_UNLIKELY(curl == NULL))
    {
        return -1;
    }
    ...
    if (user_agent == NULL)
    {
        user_agent = MY_COMPANY_FOUNDATIONAL_LIB_DEFAULT_USER_AGENT;
    }
    ...
    data.string = MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_MALLOC(MY_COMPANY_FOUNDATIONAL_LIB_INITIAL_NETWORK_DOWNLOAD_BUFFER_SIZE);
    data.alloc_size = MY_COMPANY_FOUNDATIONAL_LIB_INITIAL_NETWORK_DOWNLOAD_BUFFER_SIZE;
    data.size = 0;
    data.byte_max_cutoff = byte_max_cutoff;

    curl_easy_setopt(curl, CURLOPT_WRITEFUNCTION, MY_COMPANY_FOUNDATIONAL_LIB_libcurl_write_callback);
...
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NONNULL
MY_COMPANY_MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_NOTHROW
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_download_websites(const char **websites_to_download, size_t num_websites, char ***outputs, size_t **lens, size_t byte_limit, int aggressive_stop_on_error)
{

    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(websites_to_download);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(outputs);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(lens);
    // Initalize all to NULL in case a site can't download
    *outputs = (char **)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_CALLOC(num_websites, sizeof(char *));

    // Initalize all to 0 in case a site can't download
    *lens = (size_t *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_CALLOC(num_websites, sizeof(size_t));

    for (size_t i = 0; i < num_websites; ++i)
    {
        size_t alloc_size;
        if (MY_COMPANY_download_website(websites_to_download[i], (*outputs) + i, (*lens) + i, &alloc_size, byte_limit, NULL) == -1)
        {
 ...
 */
MY_COMPANY_FOUNDATIONAL_LIB_FUNC int MY_COMPANY_read_files_into_array(const char **files_to_open, size_t num_files, char ***outputs, size_t **lens, int aggressive_stop_on_error)
{
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(files_to_open);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(outputs);
    MY_COMPANY_MY_COMPANY_FOUNDATIONAL_LIB_ASSERT_ARGUMENT_IF_ENABLED(lens);
    // Initalize all to NULL in case a site can't download
    *outputs = (char **)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_CALLOC(num_files, sizeof(char *));

    // Initalize all to 0 in case a site can't download
    *lens = (size_t *)MY_COMPANY_FOUNDATIONAL_LIB_MEMORY_ALLOCATOR_CALLOC(num_files, sizeof(size_t));

    for (size_t i = 0; i < num_files; ++i)
    {
        size_t size;

        (*outputs)[i] = MY_COMPANY_read_file_into_string(files_to_open[i], &size);
        (*lens)[i] = size;
